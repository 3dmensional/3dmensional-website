<template>
  <footer class="d-flex">
    ...
    <div class="container d-grid">
      ...
      <div class="nav">
        <ul>
          <li><a href="#" @click.prevent="scroll">Home</a></li>
          <li><a href="#About" @click.prevent="scroll">About Us</a></li>
          <li><a href="#Services" @click.prevent="scroll">Services</a></li>
          <li><a href="#Contact" @click.prevent="scroll">Contact</a></li>
        </ul>
      </div>
      <div class="social">

        <div class="icons">
          <a target="_blank" href="https://www.facebook.com/3dmensionalg/">

            <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'facebook-f' }" />
          </a>
          <a target="_blank" href="https://www.twitter.com/3dmensionalg/">

            <font-awesome-icon :icon="{ prefix: 'fab', iconName: 'twitter' }" />
          </a>
          <a target="_blank" href="https://www.instagram.com/3dmensionalg/">
